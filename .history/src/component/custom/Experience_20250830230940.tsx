...
const ExperienceList:Array<experienceList> = [
    ...
    {name:"Stage Developpeur d'application",content:["Développement d'un système de refroidissement intelligent","Développement d'une interface de refroidissement intelligent"]},
]

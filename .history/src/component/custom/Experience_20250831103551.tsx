...
const ExperienceList:Array<experienceList> = [
    ...
    {name:"Stage Développeur d'application",content:["Développement d'un système de refroidissement autonome","Développement d'une interface de gestion de traduction"]},
]
